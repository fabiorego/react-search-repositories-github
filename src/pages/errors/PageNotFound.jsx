...
import '../../styles/errors/PageNotFound.css';
...
class NotFound extends React.Component {
  ...
  componentDidMount() {
    document.title = 'PageNotFound - Search GitHub Repositories';
  }

  render() {
    return (
      <main className="page-not-found-container text-center">
        <div className="form-page-not-found">
          <div className="mb-4">
            <img
