...
class Home extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <nav class="navbar navbar-dark bg-light shadow-sm fixed-top">
          ...
          <div class="nav-link nav-link-color" onClick={this.handleLogOut}>
        ...
        <main role="main">
          <section class="jumbotron text-center">
            <div class="container">
              ...
              >
                <label htmlFor="inputSearch" class="sr-only">
                  Search by
                </label>
                <input
                  type="text"
                ...
                <button class="btn btn-secondary" type="reset" onClick={this.handleReset}>
                  Clear
                </button>
              </form>
            </div>
          ...
          <div>
            <div className="home-repository-results-container" id="results">
              ...
              this.state.searchResult.query.length > 0 ? (
                <div class="home-repository-search-query">Search query not found...</div>
              ) : (
        ...
        <footer class="text-muted">
          <div class="container nav-link-color">
            <p class="float-right">
