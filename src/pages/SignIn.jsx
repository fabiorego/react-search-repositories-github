...
class MyForm extends React.Component {
  ...
  componentDidMount() {
    document.title = 'SignIn - Search GitHub Repositories';
  }

  render() {
    // If there are errors in the formik form, we specify a special class in the main HTML tag "signIn-container-with-errors";
    // If there are no errors, formik form is generated with a standard sign-in container
    let mainClassName;
    if (this.props.errors.inputEmail || this.props.errors.inputPassword) {
      mainClassName = 'signin-container signIn-container-with-errors text-center';
    } else {
      mainClassName = 'signin-container text-center';
    }
    return (
      <div>
        <main className={mainClassName}>
          <form className="form-signin" onSubmit={this.props.handleSubmit}>
            <div className="form-group">
              ...
              <div className="mb-4">
                <h1 className="title-signin">Please sign in</h1>
              </div>
              <label
                htmlFor="inputEmail"
                className="sr-only"
            ...
            <div className="button-signin">
              <button
                type="button"
                className="btn btn-lg btn-secondary button-signin-reset"
              ...
              <button
                className="btn btn-lg btn-primary button-signin-submit"
                type="submit"
